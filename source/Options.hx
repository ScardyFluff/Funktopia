...
class CpuStrums extends Option
{
	...
	private override function updateDisplay():String
	{
		return  FlxG.save.data.cpuStrums ? "CPU Strums Light Up" : "CPU Strums Don't Light Up";
	}
...
class FreeplayCutsceneOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.freeplaycut ? "Don't skip Freeplay intros" : "Skip Freeplay intros";
	}
}
